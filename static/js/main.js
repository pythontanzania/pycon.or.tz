(function ($) {
  ...
  function initNavbar() {
    if (
      !$('section:first').is('.parallax-bg, .dark-bg, .colored-bg') &&
    ...
    $(
      '#topnav .navigation-menu a[data-scroll="true"], #aside-nav .navigation-menu a[data-scroll="true"]',
    ).on('click', function () {
      if ($(window).width() < 992) {
        $('.menu-toggle').click();
      }
  ...
  function initScroll() {
    $(window)
      .scroll(function () {
        if (
          $('section:first').is('.parallax-bg, .dark-bg, #home, .colored-bg') ||
          $('#home-slider').length
        ) {
          if ($(window).width() > 991) {
            if (
              $(window).scrollTop() >= $('#topnav').height() &&
  ...
  function initGeneral() {
    ...
    $(
      '#topnav .navigation-menu a[href*="#"], #aside-nav .navigation-menu a[href*="#"], a.btn[href*="#"]',
    )
      .not('[href="#"]')
    ...
    $('.circle-bar-wrap').each(function (index, el) {
      $(el).appear(function () {
        var options = {
          ...
          trailColor:
            $(el).data('color') == '#fff' ? 'rgba(255,255,255,0.25)' : '#eee',
        };
  ...
  function initHomeSlider() {
    ...
    options.start = function () {
      var delay = 0;
      var currentSlide = $('#home-slider').find(
      ...
      $('#home-slider')
        .find('.slides > li.flex-active-slide .slide-content > .container')
        .children()
        .each(function () {
          var $content = $(this);
          setTimeout(function () {
    ...
    options.before = function () {
      $('#home-slider')
        .find('.slides > li .slide-content > .container')
        .children()
        .each(function () {
          var $content = $(this);
          $content.css({
  ...
  function initSliders() {
    ...
    $('.flexslider').each(function (index, el) {
      ...
      options.start = function () {
        ...
        $(el)
          .find('.slides > li.flex-active-slide .slide-caption')
          .children()
          .each(function () {
            var $content = $(this);
            setTimeout(function () {
  ...
  function initCarousels() {
    $('.owl-carousel').each(function (index, el) {
      ...
      var options = {
        ...
        navText: [
          '<i class="hc-angle-left"></i>',
          '<i class="hc-angle-right"></i>',
        ],
  ...
  function initPhotoGallery() {
    ...
    $('.photo-gallery').on('click', '.gallery-item a', function (event) {
      ...
      template +=
        '<a href="#" class="gallery-control gallery-prev"><i class="hc-angle-left"></i></a>';
      template +=
        '<img src="' + imagesArray[imagesArray.indexOf(image)] + '" alt="">';
      template +=
        '<a href="#" class="gallery-control gallery-next"><i class="hc-angle-right"></i></a>';
      template += '</div>';
      template += '</div>';
      template += '</div>';
      template += '</div>';
    ...
    $('form[data-mailchimp]').each(function (index, el) {
      $(el).ajaxChimp({
        ...
        callback: function (res) {
          ...
          template +=
            '<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><i class="hc-close"></i></span></button>';
