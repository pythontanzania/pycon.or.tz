        ...
        if (
          ...
          if (
            ...
            if ((!s && 27 != i.which) || (s && 27 == i.which))
              return (
                27 == i.which && o.find(r).trigger('focus'),
                n.trigger('click')
              );
      ...
      t(document).on(
        ...
        function (i) {
          var n = t(this),
            ...
            s = r.data('bs.modal')
              ? 'toggle'
              : t.extend({ remote: !/#/.test(o) && o }, r.data(), n.data());
    ...
    function e(e) {
      return this.each(function () {
        ...
        (o || !/destroy|hide/.test(e)) &&
          (o || n.data('bs.tooltip', (o = new i(this, r))),
          'string' == typeof e && o[e]());
      });
    }
    var i = function (t, e) {
    ...
    ((i.VERSION = '3.3.6'),
      ...
      (i.prototype.show = function () {
        ...
        if (this.hasContent() && this.enabled) {
          ...
          if (u) {
            ...
            ((a =
              'bottom' == a && h.bottom + c > f.bottom
                ? 'top'
                : 'top' == a && h.top - c < f.top
                  ? 'bottom'
                  : 'right' == a && h.right + p > f.width
                    ? 'left'
                    : 'left' == a && h.left - p < f.left
                      ? 'right'
                      : a),
      ...
      (i.prototype.applyPlacement = function (e, i) {
        ...
        var p = /top|bottom/.test(i),
          c = p ? 2 * h.left - o + l : 2 * h.top - r + u,
          d = p ? 'offsetWidth' : 'offsetHeight';
        (n.offset(e), this.replaceArrow(c, n[0][d], p));
      }),
      ...
      (i.prototype.getViewportAdjustedDelta = function (t, e, i, n) {
        ...
        if (/right|left/.test(t)) {
          ...
          u < s.left
            ? (o.left = s.left - u)
            : h > s.right && (o.left = s.left + s.width - h);
        }
        return o;
      }),
    ...
    function e(e) {
      return this.each(function () {
        var n = t(this),
          ...
          r = 'object' == typeof e && e;
        (o || !/destroy|hide/.test(e)) &&
          (o || n.data('bs.popover', (o = new i(this, r))),
          'string' == typeof e && o[e]());
      });
    }
    var i = function (t, e) {
    ...
    t.fn.downCount = function (e, i) {
      function n() {
        ...
        (r.find('.days').text(c),
          ...
          r.find('.seconds').text(m),
          r.find('.days_ref').text(y),
          r.find('.hours_ref').text(g),
          r.find('.minutes_ref').text(v),
          r.find('.seconds_ref').text(w));
      }
      ...
      (t.data(i, 'flexslider', o),
        (y = {
          init: function () {
            ((o.animating = !1),
              ...
              o.doMath(),
              o.setup('init'),
              o.vars.controlNav && y.controlNav.setup(),
              o.vars.directionNav && y.directionNav.setup(),
              o.vars.keyboard &&
              ...
              o.vars.pausePlay && y.pausePlay.setup(),
              o.vars.slideshow &&
              ...
              o.vars.slideshow &&
                ...
                (o.vars.pauseInvisible && y.pauseInvisible.isHidden()) ||
                  (o.vars.initDelay > 0
                    ? (o.startTimeout = setTimeout(o.play, o.vars.initDelay))
                    : o.play())),
              m && y.asNav.setup(),
              l && o.vars.touch && y.touch(),
              (!f || (f && o.vars.smoothHeight)) &&
                t(window).bind('resize orientationchange focus', y.resize),
            ...
            setupPaging: function () {
              ...
              (o.controlsContainer
                ...
                o.controlNavScaffold.delegate('a, img', u, function (e) {
                  ...
                  ('' === h && (h = e.type), y.setToClearWatchedEvent());
                }));
            },
          ...
          pausePlay: {
            setup: function () {
              ...
              (o.controlsContainer
                ...
                y.pausePlay.update(o.vars.slideshow ? s + 'pause' : s + 'play'),
          ...
          touch: function () {
                          ...
                          : d && o.currentSlide === o.last
                            ...
                            : d
                              ? (o.itemW + o.vars.itemMargin) *
                                ...
                                o.currentSlide
                              : c
                                ? (o.last - o.currentSlide + o.cloneOffset) * u
                                : (o.currentSlide + o.cloneOffset) * u)));
            }
            function e(t) {
              t.stopPropagation();
                    ...
                    : void (
                        ...
                        !f &&
                          ...
                          (e.vars.animationLoop ||
                            (h =
                              T /
                              ((0 === e.currentSlide && 0 > T) ||
                              (e.currentSlide === e.last && T > 0)
                                ? Math.abs(T) / u + 2
                                : 1)),
                          e.setProps(l + h, 'setTouch')))
                      )
                );
              }
            }
            function n(t) {
              ...
              var e = t.target._slider;
              if (e) {
                if (e.animatingTo === e.currentSlide && !w && null !== h) {
                  var i = c ? -h : h,
                    n = i > 0 ? e.getTarget('next') : e.getTarget('prev');
                  e.canAdvance(n) &&
                  ((Number(new Date()) - m < 550 && Math.abs(i) > 50) ||
                    Math.abs(i) > u / 2)
                    ? e.flexAnimate(n, e.vars.pauseOnAction)
                    : f ||
                      e.flexAnimate(e.currentSlide, e.vars.pauseOnAction, !0);
                }
                ((r = null), (s = null), (h = null), (l = null), (T = 0));
              }
            }
            var r,
              s,
              ...
              : ((y = function (t) {
                            ...
                            : d && o.currentSlide === o.last
                              ...
                              : d
                                ? (o.itemW + o.vars.itemMargin) *
                                  ...
                                  o.currentSlide
                                : c
                                  ? (o.last - o.currentSlide + o.cloneOffset) *
                                    u
                                  : (o.currentSlide + o.cloneOffset) * u),
                      (r = p ? _ : b),
                      (s = p ? b : _),
                ...
                (g = function (t) {
                  ((b = t.touches[0].pageX),
                    ...
                    (h = p ? r - _ : r - b),
                    (w = p
                      ? Math.abs(h) < Math.abs(b - s)
                      : Math.abs(h) < Math.abs(_ - s)));
                  var e = 500;
                  (!w || Number(new Date()) - m > e) &&
                    (t.preventDefault(),
                    !f &&
                      o.transitions &&
                      (o.vars.animationLoop ||
                        (h /=
                          ...
                          (o.currentSlide === o.last && h > 0)
                            ? Math.abs(h) / u + 2
                            : 1),
                      o.setProps(l + h, 'setTouch')));
                }),
                (v = function (t) {
                  if (
                    (i.removeEventListener('touchmove', g, !1),
                    o.animatingTo === o.currentSlide && !w && null !== h)
                  ) {
                    var e = c ? -h : h,
                      n = e > 0 ? o.getTarget('next') : o.getTarget('prev');
                    o.canAdvance(n) &&
                    ((Number(new Date()) - m < 550 && Math.abs(e) > 50) ||
                      Math.abs(e) > u / 2)
                      ? o.flexAnimate(n, o.vars.pauseOnAction)
                      : f ||
          ...
          pauseInvisible: {
            visProp: null,
            init: function () {
              var t = y.pauseInvisible.getHiddenProp();
              if (t) {
        ...
        (o.flexAnimate = function (e, i, n, r, a) {
          if (
            ...
            if (
              ...
              i && o.pause(),
              o.vars.before(o),
              o.syncExists && !a && y.sync('animate'),
              o.vars.controlNav && y.controlNav.active(),
              d ||
                o.slides
                  .removeClass(s + 'active-slide')
                  .eq(e)
              ...
              o.vars.directionNav && y.directionNav.update(),
              e === o.last &&
              ...
              var h,
                g,
                v,
                w = p ? o.slides.filter(':first').height() : o.computedW;
              (d
                ? ((h = o.vars.itemMargin),
                  (v = (o.itemW + h) * o.move * o.animatingTo),
                  (g = v > o.limit && 1 !== o.visible ? o.limit : v))
                : (g =
                    0 === o.currentSlide &&
                    e === o.count - 1 &&
                    o.vars.animationLoop &&
        ...
        (o.pause = function () {
          (clearInterval(o.animatedSlides),
            ...
            (o.playing = !1),
            o.vars.pausePlay && y.pausePlay.update('play'),
            o.syncExists && y.sync('pause'));
        }),
        (o.play = function () {
          (o.playing && clearInterval(o.animatedSlides),
            ...
            o.vars.pausePlay && y.pausePlay.update('pause'),
            o.syncExists && y.sync('play'));
        }),
        (o.stop = function () {
          (o.pause(), (o.stopped = !0));
        }),
        ...
        (o.update = function (t, e) {
          (o.doMath(),
            ...
            o.vars.controlNav &&
              !o.manualControls &&
              (('add' === e && !d) || o.pagingCount > o.controlNav.length
                ...
                : (('remove' === e && !d) ||
                  ...
                  y.controlNav.update('remove', o.last))),
            o.vars.directionNav && y.directionNav.update());
        }),
    ...
    function r(e) {
      ...
      function r(t) {
        if (
          ...
          for (
            var s = (r.isBorderBox = !(!h || !e[h] || 'border-box' !== e[h])),
              c = 0,
              d = a.length;
            d > c;
            c++
          ...
          var g = r.paddingLeft + r.paddingRight,
            ...
            x = s && p,
            P = i(e.width);
          P !== !1 && (r.width = P + (x ? 0 : g + _));
          var C = i(e.height);
          return (
            C !== !1 && (r.height = C + (x ? 0 : v + T)),
            (r.innerWidth = r.width - (g + _)),
        ...
        for (var o = [], r = 0, s = t.length; s > r; r++) {
          ...
          if (n.isElement(a))
            if (e) {
              i(a, e) && o.push(a);
              for (
                var l = a.querySelectorAll(e), u = 0, h = l.length;
                h > u;
                u++
              )
                o.push(l[u]);
  ...
  (function (t, e) {
    ...
    ((s.prototype.enableTransition = function () {
      ...
      (s.prototype.transition =
        s.prototype[h ? '_transition' : '_nonTransition']),
            ...
            (o.attr('novalidate', 'true'),
              ...
              o.submit(function () {
                function e(e) {
                  ...
                  ('en' !== a.language &&
                    void 0 !== t.ajaxChimp.responses[i] &&
                    t.ajaxChimp.translations &&
                    t.ajaxChimp.translations[a.language] &&
                    t.ajaxChimp.translations[a.language][
                ...
                return (
                  'en' !== a.language &&
                    t.ajaxChimp.translations &&
                    t.ajaxChimp.translations[a.language] &&
                    t.ajaxChimp.translations[a.language].submit &&
                    (h = t.ajaxChimp.translations[a.language].submit),
                  s.html(h).show(2e3),
                  !1
                );
              }));
  ...
  (function (t) {
    ((t.fn.appear = function (e, i) {
      ...
      return this.each(function () {
        ...
        var o = t(window),
          r = function () {
            ...
            var t = o.scrollLeft(),
              ...
              c = i.width(),
              d = o.width();
            a + h + u >= e && a <= e + p + u && s + c + l >= t && s <= t + d + l
              ? i.appeared || i.trigger('appear', n.data)
              : (i.appeared = !1);
          },
          s = function () {
        ...
        (n.one ? i.one('appear', n.data, s) : i.bind('appear', n.data, s),
          o.scroll(r),
    ...
    ((i.DEFAULTS = {
      ...
      (t.fn.countTo = function (e) {
        return this.each(function () {
          ...
          (r && (o && o.stop(), n.data('countTo', (o = new i(this, s)))),
            o[a].call(o));
        });
      }));
  }),
    ...
    ((jQuery.fn.CSSAnimate = function (t, e, i, n, o) {
      return this.each(function () {
        ...
        if (0 !== r.length && t) {
          if (
            ('function' == typeof e &&
              ((o = e), (e = jQuery.fx.speeds._default)),
            'function' == typeof i && ((o = i), (i = 0)),
            'function' == typeof n &&
              ((o = n), (n = 'cubic-bezier(0.65,0.03,0.36,0.72)')),
            'string' == typeof e)
          )
          ...
          if (jQuery.support.transition) {
            ...
            (jQuery.browser.webkit
              ? ((a = '-webkit-'), (l = 'webkitTransitionEnd'))
              : jQuery.browser.mozilla
                ? ((a = '-moz-'), (l = 'transitionend'))
                : jQuery.browser.opera
                  ? ((a = '-o-'), (l = 'otransitionend'))
                  : jQuery.browser.msie &&
                    ((a = '-ms-'), (l = 'msTransitionEnd')),
              (s = []));
            for (h in t) {
              var u = h;
              ('transform' === u &&
                ((u = a + 'transform'), (t[u] = t[h]), delete t[h]),
                'transform-origin' === u &&
                  ((u = a + 'transform-origin'), (t[u] = t[h]), delete t[h]),
                s.push(u),
                r.css(u) || r.css(u, 0));
            }
            ((h = s.join(',')),
              r.css(a + 'transition-property', h),
              r.css(a + 'transition-duration', e + 'ms'),
              r.css(a + 'transition-delay', i + 'ms'),
              r.css(a + 'transition-timing-function', n),
              r.css(a + 'backface-visibility', 'hidden'),
              setTimeout(function () {
                r.css(t);
              }, 0),
              setTimeout(function () {
                r.called || !o ? (r.called = !1) : o();
              }, e + 20),
              r.on(l, function (t) {
                return (
                  r.off(l),
                  r.css(a + 'transition', ''),
                  t.stopPropagation(),
                  'function' == typeof o && ((r.called = !0), o()),
                  !1
                );
              }));
          } else {
            for (var h in t)
              ('transform' === h && delete t[h],
                'transform-origin' === h && delete t[h],
                'auto' === t[h] && delete t[h]);
            ((o && 'string' != typeof o) || (o = 'linear'), r.animate(t, e, o));
          }
        }
      });
    }),
      (jQuery.fn.CSSAnimateStop = function () {
        var t = '',
          e = 'transitionEnd';
        (jQuery.browser.webkit
          ? ((t = '-webkit-'), (e = 'webkitTransitionEnd'))
          : jQuery.browser.mozilla
            ? ((t = '-moz-'), (e = 'transitionend'))
            : jQuery.browser.opera
              ? ((t = '-o-'), (e = 'otransitionend'))
              : jQuery.browser.msie && ((t = '-ms-'), (e = 'msTransitionEnd')),
          jQuery(this).css(t + 'transition', ''),
          jQuery(this).off(e));
      }),
          ...
          metadata: {
            ...
            get: function (b, f) {
              ...
              if (((a = '{}'), 'class' == d.type)) {
                ...
                void 0 != b.getAttribute &&
                  (e = b.getAttribute(d.name)) &&
                  (a = e);
              return (
                0 > a.indexOf('{') && (a = '{' + a + '}'),
                (a = eval('(' + a + ')')),
      ...
      (String.prototype.getVideoID = function () {
        var t;
        return (t =
          'http://youtu.be/' == this.substr(0, 16)
            ? this.replace('http://youtu.be/', '')
            : this.indexOf('http') > -1
              ? this.match(/[\\?&]v=([^&#]*)/)[1]
              : this);
      }),
      (jQuery.mbYTPlayer = {
        ...
        locationProtocol:
          'file:' != location.protocol ? location.protocol : 'http:',
          ...
          return this.each(function () {
            ...
            (canGoFullscreen || (YTPlayer.opt.realfullscreen = !1),
              ...
              YTPlayer.opt.isBgndMovie &&
                void 0 != YTPlayer.opt.isBgndMovie.mute &&
                (YTPlayer.opt.mute = YTPlayer.opt.isBgndMovie.mute),
              YTPlayer.opt.videoURL ||
                (YTPlayer.opt.videoURL = $YTPlayer.attr('href')));
            var playerID = 'mbYTP_' + YTPlayer.id,
              videoID = this.opt.videoURL
            ...
            if (
              ...
              (YTPlayer.isBackground =
                'body' ==
                YTPlayer.opt.containment.get(0).tagName.toLowerCase()),
            ...
            if (
              ...
              !YTPlayer.isBackground || !ytp.isInit)
            ) {
              if (
                ...
                (YTPlayer.isBackground && ytp.isInit) ||
                  ...
                  (YTPlayer.isBackground &&
                    ...
                    jQuery(document)
                      ...
                      .on('mousedown,.ytplayer', function (t) {
                        var e = jQuery(t.target);
                        (e.is('a') || e.parents().is('a')) &&
                          $YTPlayer.pauseYTP();
                      }),
                  YTPlayer.isBackground && (ytp.isInit = !0),
                  ...
                  jQuery(document).on(
                    'getVideoInfo_' + YTPlayer.opt.id,
                    function () {
                      return ytp.isDevice && !YTPlayer.isBackground
                        ...
                        : void new YT.Player(playerID, {
                            ...
                            events: {
                              ...
                              onStateChange: function (t) {
                                if (
                                  'function' == typeof t.target.getPlayerState
                                ) {
                                  var e = t.target.getPlayerState();
                                  'function' ==
                                    typeof YTPlayer.opt.onStateChange &&
                                    YTPlayer.opt.onStateChange($YTPlayer, e);
                                  var i =
                                      (jQuery(YTPlayer.playerEl),
                                      jQuery('#controlBar_' + YTPlayer.id)),
                                    n = YTPlayer.opt;
                                  if (0 == e) {
                                    if (YTPlayer.state == e) return;
                                    ((YTPlayer.state = e),
                                      YTPlayer.player.pauseVideo());
                                    var o = YTPlayer.opt.startAt
                                      ? YTPlayer.opt.startAt
                                      : 1;
                                    (n.loop
                                      ? (YTPlayer.wrapper.css({ opacity: 0 }),
                                        $YTPlayer.playYTP(),
                                        YTPlayer.player.seekTo(o, !0))
                                      : YTPlayer.isBackground ||
                                        (YTPlayer.player.seekTo(o, !0),
                                        $YTPlayer.playYTP(),
                                        setTimeout(function () {
                              ...
                              onPlaybackQualityChange: function (t) {
                                'function' ==
                                  typeof YTPlayer.opt.onPlaybackQualityChange &&
                                  YTPlayer.opt.onPlaybackQualityChange(
                                    $YTPlayer,
                                  );
                              },
                              onError: function (t) {
              ...
              : (jQuery.getJSON(
                  ...
                  function (t, i, n) {
                    ...
                    if (
                      ...
                      (e.videoData = o),
                      'auto' == e.opt.ratio &&
                        (o.aspectRatio && 'widescreen' === o.aspectRatio
                          ? (e.opt.ratio = '16/9')
                          : (e.opt.ratio = '4/3')),
                      !e.isInit)
                    ) {
        ...
        playNext: function () {
          ...
          (t.videoCounter++,
            ...
            jQuery(t.playerEl).css({ opacity: 0 }),
        ...
        changeMovie: function (t) {
          var e = this.get(0),
            i = e.opt;
          (t && jQuery.extend(i, t),
            (e.videoID = i.videoURL.getVideoID()),
            jQuery(e).pauseYTP());
          ...
          (jQuery('#controlBar_' + e.id).remove(),
            ...
            jQuery.mbYTPlayer.getDataFromFeed(e.videoID, e),
        ...
        fullscreen: function (t) {
          function e(t, e) {
            for (
              var i, n, o = ['webkit', 'moz', 'ms', 'o', ''], r = 0;
              r < o.length && !t[i];
            ) {
              if (
                ((i = e),
                '' == o[r] && (i = i.substr(0, 1).toLowerCase() + i.substr(1)),
                (i = o[r] + i),
                (n = typeof t[i]),
                'undefined' != n)
              )
                return ((o = [o[r]]), 'function' == n ? t[i]() : t[i]);
              r++;
            }
          }
          function i(t) {
          ...
          function n() {
            (e(document, 'FullScreen') || e(document, 'IsFullScreen')) &&
              e(document, 'CancelFullScreen');
          }
          var o = this.get(0),
            r = jQuery('#controlBar_' + o.id),
            s = r.find('.mb_OnlyYT'),
            a = jQuery(o.wrapper);
          if (t) {
            var l = jQuery.browser.mozilla
              ? 'mozfullscreenchange'
              : jQuery.browser.webkit
                ? 'webkitfullscreenchange'
                : 'fullscreenchange';
            (jQuery(document).off(l),
              jQuery(document).on(l, function () {
                var t =
                  e(document, 'IsFullScreen') || e(document, 'FullScreen');
                t
                  ? jQuery(o).setVideoQuality('default')
                  : (jQuery(o).removeClass('fullscreen'),
                    (o.isAlone = !1),
                    s.html(jQuery.mbYTPlayer.controls.onlyYT),
                    jQuery(o).setVideoQuality(o.opt.quality),
                    o.isBackground
                      ? jQuery('body').after(r)
                      : o.wrapper.before(r),
          ...
          o.isAlone
            ? (t ? n() : a.CSSAnimate({ opacity: o.opt.opacity }, 500),
              jQuery(o).trigger('YTPFullScreenEnd'),
              a.css({ zIndex: -1 }),
              s.html(jQuery.mbYTPlayer.controls.onlyYT),
              (o.isAlone = !1))
            : (1 != o.player.getPlayerState() &&
                2 != o.player.getPlayerState() &&
                jQuery(o).playYTP(),
              t
                ? (o.wrapper.append(r),
                  jQuery(o).addClass('fullscreen'),
                  i(a.get(0)))
                : a.css({ zIndex: 1e4 }).CSSAnimate({ opacity: 1 }, 1e3, 0),
              jQuery(o).trigger('YTPFullScreenStart'),
              s.html(jQuery.mbYTPlayer.controls.showSite),
              (o.isAlone = !0));
        },
        playYTP: function () {
          var t = this.get(0),
          ...
          (i.html(jQuery.mbYTPlayer.controls.pause),
            t.player.playVideo(),
            t.wrapper.CSSAnimate({ opacity: t.opt.opacity }, 2e3),
        ...
        setYTPVolume: function (t) {
          var e = this.get(0);
          (t || e.opt.vol || 0 != player.getVolume()
            ? (!t && e.player.getVolume() > 0) ||
              (t && e.player.getVolume() == t)
              ? jQuery(e).muteYTPVolume()
              : (e.opt.vol = t)
            : jQuery(e).unmuteYTPVolume(),
        ...
        manageYTPProgress: function () {
          var t = this.get(0),
            ...
            l = (s * r) / a,
            u = 0,
            h = 100 * t.player.getVideoLoadedFraction();
          return (
            n.css({ left: u, width: h + '%' }),
            o.css({ left: 0, width: l }),
        ...
        buildYTPControls: function () {
          ...
          if (!jQuery('#controlBar_' + t.id).length) {
            var i = jQuery('<span/>')
              ...
              o = jQuery('<span>' + jQuery.mbYTPlayer.controls.play + '</span>')
                .addClass('mb_YTVPPlaypause ytpicon')
                .click(function () {
                  1 == t.player.getPlayerState()
                    ? jQuery(t).pauseYTP()
                    : jQuery(t).playYTP();
                }),
              r = jQuery('<span>' + jQuery.mbYTPlayer.controls.mute + '</span>')
                .addClass('mb_YTVPMuteUnmute ytpicon')
                .click(function () {
                  0 == t.player.getVolume()
            ...
            var l = jQuery('<span/>')
              ...
              h = jQuery('<div/>')
                ...
                .css('position', 'absolute')
                .click(function (e) {
                  (c.css({ width: e.clientX - c.offset().left }),
                    (t.timeW = e.clientX - c.offset().left),
                    i.find('.mb_YTVPLoaded').css({ width: 0 }));
                  var n = Math.floor(t.player.getDuration());
                  ((t['goto'] = (c.outerWidth() * n) / h.outerWidth()),
              ...
              c = jQuery('<div/>')
                ...
                .css('position', 'absolute');
            (h.append(p).append(c),
              n.append(o).append(r).append(s),
              e.printUrl && n.append(l),
              (t.isBackground || (t.opt.realfullscreen && !t.isBackground)) &&
                n.append(u),
              i.append(n).append(h),
              t.isBackground
                ? jQuery('body').after(i)
                : (i.addClass('inlinePlayer'), t.wrapper.before(i)),
              i.fadeIn());
          }
        },
        checkForState: function (t) {
          ...
          t.getState = setInterval(function () {
            ...
            (e
              .find('.mb_YTVPTime')
              .html(
                jQuery.mbYTPlayer.formatTime(o.currentTime) +
                  ' / ' +
                  jQuery.mbYTPlayer.formatTime(o.totalTime),
              ),
              parseFloat(t.player.getDuration() - 3) <
                ...
                (i.loop
                  ? t.player.seekTo(n)
                  : (t.player.pauseVideo(),
                    t.wrapper.CSSAnimate({ opacity: 0 }, 2e3, function () {
                      if ((t.player.seekTo(n, !0), !t.isBackground)) {
                        var e = t.videoData.thumbnail.hqDefault;
                        jQuery(t).css({
                          background:
                            'rgba(0,0,0,0.5) url(' + e + ') center center',
                          backgroundSize: 'cover',
                        });
                      }
                    })),
      ...
      (jQuery.fn.toggleVolume = function () {
        ...
        if (t)
          return t.player.isMuted()
            ? (jQuery(t).unmuteYTPVolume(), !0)
            : (jQuery(t).muteYTPVolume(), !1);
      }),
      (jQuery.fn.optimizeDisplay = function () {
        ...
        var r = 24,
          s = {};
        ((s.width = n.width + (n.width * r) / 100),
          (s.height =
            '16/9' == e.ratio
              ? Math.ceil((9 * n.width) / 16)
              : Math.ceil((3 * n.width) / 4)),
          (s.marginTop = -((s.height - n.height) / 2)),
          (s.marginLeft = -((n.width * (r / 2)) / 100)),
          s.height < n.height &&
            ((s.height = n.height + (n.height * r) / 100),
            (s.width =
              '16/9' == e.ratio
                ? Math.floor((16 * n.height) / 9)
                : Math.floor((4 * n.height) / 3)),
            (s.marginTop = -((n.height * (r / 2)) / 100)),
            (s.marginLeft = -((s.width - n.width) / 2))),
          i.css({
            width: s.width,
            height: s.height,
    ...
    ((o.Defaults = {
      ...
      (o.prototype.maximum = function (t) {
        ...
        if (i.loop) n = this._clones.length / 2 + this._items.length - 1;
          ...
          for (; n - r > 1; )
            Math.abs(this._coordinates[(e = (n + r) >> 1)]) < o
              ? (r = e)
              : (n = e);
        else
    ...
    })(
      {
                ...
                o = (function () {
                  ...
                  function h(t, e) {
                    var i = d.prototype.filter,
                      n = t._filterArgs;
                    r(i, function (o) {
                      'undefined' != typeof i[o][e] && i[o][e].apply(t, n);
                    });
                  }
                  function p(t, e, i, n, o, r, s, a, u, p, c) {
                    ((_ = e + i + n),
                      (T = Math.min(c || b(), _)),
                      (x = T >= _),
                      (P = n - (_ - T)),
                      t.isPlaying() &&
                        (x
                          ? (u(s, t._attachment, P), t.stop(!0))
                          : ((t._scheduleId = p(t._timeoutHandler, v)),
                            h(t, 'beforeTween'),
                            e + i > T
                              ? l(1, o, r, s, 1, 1, a)
                              : l(T, o, r, s, n, e + i, a),
              ...
              (!(function () {
                ...
                (function () {
                  function t(t, e, i, n, o, r) {
                    ...
                    function c(t, e) {
                      var i, n, o, r, a, u;
                      for (o = t, u = 0; 8 > u; u++) {
                        if (((r = s(o) - t), p(r) < e)) return o;
                        if (((a = l(o)), p(a) < 1e-6)) break;
                        o -= r / a;
                      }
                      if (((i = 0), (n = 1), (o = t), i > o)) return i;
                      if (o > n) return n;
                      for (; n > i; ) {
                        if (((r = s(o)), p(r - t) < e)) return o;
                        (t > r ? (i = o) : (n = o), (o = 0.5 * (n - i) + i));
                      }
                      return o;
                    }
                    var d = 0,
                  ...
                  function e(e, i, n, o) {
                    return function (r) {
                      return t(r, e, i, n, o, 1);
                    };
                  }
                  ((o.setBezierFunction = function (t, i, n, r, s) {
                    var a = e(i, n, r, s);
                    return (
                      (a.displayName = t),
                      (a.x1 = i),
                ...
                (function () {
                  function t(t, e, i, n, r, s) {
                    return o.tweenProps(n, e, t, i, 1, s, r);
                  }
                  var e = new o();
                  ((e._filterArgs = []),
                    (o.interpolate = function (i, n, r, s, a) {
                      var l = o.shallowCopy({}, i),
                        u = a || 0,
                        h = o.composeEasingObject(i, s || 'linear');
                      e.set({});
                      var p = e._filterArgs;
                      ((p.length = 0),
                        (p[0] = l),
                        ...
                        (p[2] = n),
                        (p[3] = h),
                        o.applyFilter(e, 'tweenCreated'),
                        o.applyFilter(e, 'beforeTween'));
                      var c = t(i, l, n, r, h, u);
                      return (o.applyFilter(e, 'afterTween'), c);
                    }));
                })(),
                (function (t) {
                  function e(t, e) {
                  ...
                  function i(t) {
                    ...
                    return (
                      e
                        ? (1 === e.length || t[0].match(b)) && e.unshift('')
                        : (e = ['', '']),
                      e.join(S)
                    );
                  }
                  function n(e) {
                    t.each(e, function (t) {
                      var i = e[t];
                      'string' == typeof i && i.match(C) && (e[t] = o(i));
                    });
                  }
                  function o(t) {
                    return l(C, t, r);
                  ...
                  function l(t, e, i) {
                    var n = e.match(t),
                      o = e.replace(t, S);
                    if (n)
                      for (var r, s = n.length, a = 0; s > a; a++)
                        ((r = n.shift()), (o = o.replace(S, i(r))));
                    return o;
                  }
                  function u(t) {
                    return l(x, t, h);
                  ...
                  function p(n) {
                    ...
                    return (
                      t.each(n, function (t) {
                        ...
                        if ('string' == typeof r) {
                          var s = g(r);
                          o[t] = { formatString: i(r), chunkNames: e(s, t) };
                        }
                      }),
                      o
                    );
                  ...
                  function c(e, i) {
                    t.each(i, function (t) {
                      for (
                        var n = e[t], o = g(n), r = o.length, s = 0;
                        r > s;
                        s++
                      )
                        e[i[t].chunkNames[s]] = +o[s];
                      delete e[t];
                    });
                  }
                  function d(e, i) {
                    t.each(i, function (t) {
                      var n = e[t],
                        o = f(e, i[t].chunkNames),
                        r = m(o, i[t].chunkNames);
                      ((n = y(i[t].formatString, r)), (e[t] = u(n)));
                    });
                  }
                  function f(t, e) {
                    for (var i, n = {}, o = e.length, r = 0; o > r; r++)
                      ((i = e[r]), (n[i] = t[i]), delete t[i]);
                    return n;
                  }
                  function m(t, e) {
                    I.length = 0;
                    for (var i = e.length, n = 0; i > n; n++) I.push(t[e[n]]);
                    return I;
                  }
                  function y(t, e) {
                    for (var i = t, n = e.length, o = 0; n > o; o++)
                      i = i.replace(S, +e[o].toFixed(4));
                    return i;
                  }
                  function g(t) {
                    return t.match(T);
                  ...
                  function v(e, i) {
                    t.each(i, function (t) {
                      ...
                      if ('string' == typeof a) {
                        var l = a.split(' '),
                          u = l[l.length - 1];
                        for (n = 0; s > n; n++) e[r[n]] = l[n] || u;
                      } else for (n = 0; s > n; n++) e[r[n]] = a;
                      delete e[t];
                    });
                  }
                  function w(e, i) {
                  ...
                  t.prototype.filter.token = {
                    tweenCreated: function (t, e, i, o) {
                      (n(t), n(e), n(i), (this._tokenData = p(t)));
                    },
          ...
          function (t, e, i) {
            var n = t('shifty'),
              ...
              s = function a(t, e) {
                ...
                var i;
                ((i = o.isString(t) ? document.querySelector(t) : t),
                  (this.path = i),
                  (this._opts = e),
              ...
              (s.prototype.animate = function (t, e, i) {
                ...
                ((this._tweenable = new n()),
                  this._tweenable.tween({
                    from: o.extend({ offset: u }, l.from),
                    to: o.extend({ offset: h }, l.to),
                    duration: e.duration,
                    easing: a,
                    step: function (t) {
              ...
              (s.prototype._initializeTextContainer = function (t, e, i) {
                t.text.style &&
                  ...
                  t.text.alignToBottom
                    ? r.setStyle(i, 'transform', 'translate(-50%, 0)')
                    : r.setStyle(i, 'transform', 'translate(-50%, 50%)'));
              }),
              ...
              s = function a(t, e) {
                ...
                if (0 !== arguments.length) {
                  ((this._opts = o.extend(
                    ...
                    o.isObject(e) &&
                      void 0 !== e.svgStyle &&
                      (this._opts.svgStyle = e.svgStyle),
                    o.isObject(e) &&
                      o.isObject(e.text) &&
                      void 0 !== e.text.style &&
                      (this._opts.text.style = e.text.style));
                  var i,
                    r = this._createSvgView(this._opts);
                  if (((i = o.isString(t) ? document.querySelector(t) : t), !i))
                  ...
                  ((this._progressPath = new n(r.path, s)),
        ...
        8: [
          function (t, e, i) {
            ...
            function r(t, e, i) {
              for (var n = t.style, o = 0; o < m.length; ++o) {
                var r = m[o];
                n[r + a(e)] = i;
              }
              n[e] = i;
